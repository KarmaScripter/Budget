...
namespace BudgetExecution
{
    ...
    /// <remarks>
    /// MDI child forms do not support the Fade method and only support other methods
    /// while being displayed for the first time and when closing
    /// </remarks>
    [ SuppressMessage( "ReSharper", "MemberCanBePrivate.Global" ) ]
    public sealed class FormAnimator
    {
        /// <summary> Gets or sets the animation method used to show and hide the form </summary>
        ...
        /// <summary> Gets or Sets the direction in which the animation is performed </summary>
        ...
        /// <summary>
        /// Gets or Sets the number of milliseconds over which the animation is
        /// played
        /// </summary>
        /// <value> The number of milliseconds over which the animation is played </value>
        ...
        /// Creates a new
        /// <b> FormAnimator </b>
        /// object for the specified form using the specified method over the specified
        /// duration
        /// </summary>
        /// <param name = "form" > The form to be animated </param>
        ...
        /// Creates a new
        /// <b> FormAnimator </b>
        /// object for the specified form using the specified method in the specified
        ...
        public enum AnimationMethod
        {
            ...
            /// <remarks> This is the default animation method and requires a direction </remarks>
            Roll = 0x0,

            /// <summary>
            /// Expands out from center when showing and collapses into center when
            /// hiding
            /// </summary>
            Center = 0x10,

            /// <summary> Slides out from edge when showing and slides into edge when hiding </summary>
            /// <remarks> Requires a direction </remarks>
            Slide = 0x40000,

            /// <summary>
            /// Fades from transparent to opaque when showing and from opaque to
            /// transparent when hiding
            /// </summary>
            Fade = 0x80000
        }

        /// <summary> The directions in which the Roll and Slide animations can be shown </summary>
        /// <remarks>
        /// Horizontal and vertical directions can be combined to create diagonal
        /// animations
        /// </remarks>
        [ Flags ]
