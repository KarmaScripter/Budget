...
namespace BudgetExecution
{
    ...
    public class PayrollActivity
    {
        ...
        /// <summary> Gets or sets the sub rc code. </summary>
        /// <value> The sub rc code. </value>
        public string SubRcCode { get; set; }

        /// <summary> Gets or sets the name of the sub rc. </summary>
        /// <value> The name of the sub rc. </value>
        ...
        /// <summary> Gets or sets the pay period. </summary>
        /// <value> The pay period. </value>
        ...
        /// <summary> Gets or sets the check date. </summary>
        ...
        /// <summary> Gets or sets the base paid. </summary>
        /// <value> The base paid. </value>
        public double BasePaid { get; set; }

        /// <summary> Gets or sets the base hours. </summary>
        /// <value> The base hours. </value>
        public double BaseHours { get; set; }

        /// <summary> Gets or sets the benefits. </summary>
        /// <value> The benefits. </value>
        public double Benefits { get; set; }

        /// <summary> Gets or sets the overtime paid. </summary>
        /// <value> The overtime paid. </value>
        public double OvertimePaid { get; set; }

        /// <summary> Gets or sets the overtime hours. </summary>
        /// <value> The overtime hours. </value>
