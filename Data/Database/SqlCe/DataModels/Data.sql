...
(
   [AccountingEventsId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80)
);
...
(
   [AccountsId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [alCode] NVARCHAR(80),
...
CREATE TABLE [als]
(
   [alsId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80),
   [Title] NVARCHAR(80)
);
...
(
   [AnnualReimbursableEstimatesId] INT NOT NULL IDENTITY (1,1),
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [FundCode] NVARCHAR(80),
   [FundName] NVARCHAR(80),
...
(
   [AppropriationsId] INT NOT NULL IDENTITY (1,1),
...
(
   [BudgetObjectClassesId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80)
);
...
(
   [CapitalPlanningInvestmentCodesId] INT NOT NULL IDENTITY (1,1),
   [Type] NVARCHAR(80),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80)
);
...
(
   [CarryoverRequestsId] INT NOT NULL IDENTITY (1,1),
...
(
   [CostAreasId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80)
);
...
(
   [DocumentControlNumbersId] INT NOT NULL IDENTITY (1,1),
   [RpioCode] NVARCHAR(80),
   [RpioName] NVARCHAR(80),
   [DocumentType] NVARCHAR(80),
   [DocumentNumber] NVARCHAR(80),
...
(
   [EarmarksId] INT NOT NULL IDENTITY (1,1),
   [RpioCode] NVARCHAR(80),
   [RpioName] NVARCHAR(80),
   [FundCode] NVARCHAR(80),
   [FundName] NVARCHAR(80),
...
(
   [ExpendituresId] INT NOT NULL IDENTITY (1,1),
   [ObligationsId] INT,
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [RpioCode] NVARCHAR(80),
...
(
   [FiscalYearsBackUpId] INT NOT NULL IDENTITY (1,1),
   [FiscalYearsId] INT,
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [FirstYear] NVARCHAR(80),
   [LastYear] NVARCHAR(80),
   [ExpiringYear] NVARCHAR(80),
...
(
   [FullTimeEquivialentsId] INT NOT NULL IDENTITY (1,1),
...
(
   ...
   [MAIN] NVARCHAR(80),
   [SUB] NVARCHAR(80),
   [FundCatery] NVARCHAR(80),
   [AppropriationCode] NVARCHAR(80),
   [SubAppropriationCode] NVARCHAR(80),
   [FundGroup] NVARCHAR(80),
   [NoYear] NVARCHAR(80),
   [Carryover] NVARCHAR(80),
   [AllowSpendAgainstCanceled] NVARCHAR(80),
   [AllowNewSpendAgainstExpired] NVARCHAR(80),
...
(
   [FundSymbolsId] INT NOT NULL IDENTITY (1,1),
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [FundCode] NVARCHAR(80),
   [FundName] NVARCHAR(80),
...
(
   [GsPayScalesId] INT NOT NULL IDENTITY (1,1),
   [LOCNAME] NVARCHAR(80),
   [GRADE] FLOAT,
   [ANNUAL1] FLOAT,
   [HOURLY1] NVARCHAR(80),
...
(
   [HeadquartersAuthorityId] INT NOT NULL IDENTITY (1,1),
   [StatusOfFundsId] INT NOT NULL,
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [RpioCode] NVARCHAR(80),
...
(
   [HeadquartersOfficesId] INT NOT NULL IDENTITY (1,1),
...
(
   [InfrastructureAccountsId] INT NOT NULL IDENTITY (1,1),
...
(
   [LedgerAccountsId] INT NOT NULL IDENTITY (1,1),
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [FundCode] NVARCHAR(80),
   [FundName] NVARCHAR(80),
...
(
   [OperatingPlanUpdatesId] INT NOT NULL IDENTITY (1,1),
   [OppId] INT,
   [RPIO] NVARCHAR(80),
   [BFY] NVARCHAR(80),
   [BudgetLevel] NVARCHAR(80),
...
(
   [ProgramProjectsId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80),
   [ProgramAreaCode] NVARCHAR(80),
   [ProgramAreaName] NVARCHAR(80)
...
(
   [ReferenceTablesId] INT NOT NULL IDENTITY (1,1),
   [TableName] NVARCHAR(80),
   [Type] NVARCHAR(80)
);
...
(
   [RegionalOfficesId] INT NOT NULL IDENTITY (1,1),
   [ResourcePlanninfficesId] INT,
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80)
);
...
(
   [ReportsId] INT NOT NULL IDENTITY (1,1),
   [Name] NVARCHAR(80),
   [Title] NVARCHAR(80)
);
...
(
   [ResourcePlanninfficesId] INT NOT NULL IDENTITY (1,1),
   [Code] NVARCHAR(80),
   [Name] NVARCHAR(80)
);
...
(
   [SupplementalAuthorityId] INT NOT NULL IDENTITY (1,1),
   [StatusOfFundsId] INT,
   [BudgetLevel] NVARCHAR(80),
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
...
(
   [SupplementalCarryoverEstimatesID] INT NOT NULL IDENTITY (1,1),
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [FundCode] NVARCHAR(80),
   [FundName] NVARCHAR(80),
...
(
   [ReimbursableEstimatesId] INT NOT NULL IDENTITY (1,1),
   [BFY] NVARCHAR(80),
   [EFY] NVARCHAR(80),
   [FundCode] NVARCHAR(80),
   [FundName] NVARCHAR(80),
...
(
   [TransTypesId] INT NOT NULL IDENTITY (1,1),
   [FundCode] NVARCHAR(80),
...
(
   [TravelActivityId] INT NOT NULL IDENTITY (1,1),
   [RpioCode] NVARCHAR(80),
   [RpioName] NVARCHAR(80),
   [BFY] NVARCHAR(80),
   [AhCode] NVARCHAR(80),
