...
(
    ...
    [TreasuryAppropriationFundSymbol] NVARCHAR
(
    80
),
    [TreasuryAppropriationFundSymbolName] NVARCHAR
(
    80
),
...
(
    ...
    [AppropriationFundCode] NVARCHAR
(
    80
),
    [AppropriationFundName] NVARCHAR
(
    80
),
...
(
    ...
    [EstimatedReimbur0sements] DECIMAL
(
    18,
    0
) DEFAULT
...
(
    ...
    [EstimatedReimbursements] DECIMAL
(
    18,
    0
),
...
(
    ...
    [EstimatedReimbursementsSpendinption] NVARCHAR
(
    80
),
    [EstimatedReimursementsBudgetinption] NVARCHAR
(
    80
),
...
(
    ...
    [EstimatedRecoveriesSpendinption] NVARCHAR
(
    80
),
    [EstimatedRecoveriesBudgetinption] NVARCHAR
(
    80
),
...
(
    ...
    [ProfitLossSpendinption] NVARCHAR
(
    80
),
...
(
    ...
    [PostedControlFlag] NVARCHAR
(
    80
),
    [ActualRecoveryTransType] NVARCHAR
(
    80
),
    [CommitmentSpendingControlFlag] NVARCHAR
(
    80
),
    [BudgetDefault] NVARCHAR
(
    80
),
    [LowerChildExpenditureSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerChildExpenseSpendingControlFlag] NVARCHAR
(
    80
),
    [FteControlFlag] NVARCHAR
(
    80
),
    [AccrualSpendingControlFlag] NVARCHAR
(
    80
),
    [ObligationSpendingControlFlag] NVARCHAR
(
    80
),
    [PreCommitmentSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerCommitmentSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerObligationSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerExpenditureSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerExpenseSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerPostedControlFlag] NVARCHAR
(
    80
),
    [LowerPostedTransType] NVARCHAR
(
    80
),
    [LowerTransType] NVARCHAR
(
    80
),
    [LowerPostedFlag] NVARCHAR
(
    80
),
    [LowerPreCommitmentSpendingControlFlag] NVARCHAR
(
    80
),
    [LowerRecoveriesSpendinption] NVARCHAR
(
    80
),
    [LowerRecoveriesOption] NVARCHAR
(
    80
),
    [LowerReimbursableSpendinption] NVARCHAR
(
    80
),
    [Date] DATETIME,
...
(
    ...
    [CarryoverAvailabilityPercentage] DECIMAL
(
    18,
    0
),
...
(
    ...
    [RecoveriesWithdrawn] DECIMAL
(
    18,
    0
),
    [ActualRecoveries] DECIMAL
(
    18,
    0
),
    [ActualReimbursements] DECIMAL
(
    18,
    0
),
    [AgreementReimbursables] DECIMAL
(
    18,
    0
)
...
(
    ...
    [UnliquidatedObligations] DECIMAL
(
    18,
    0
),
    [ObligationsPaid] DECIMAL
(
    18,
    0
)
...
(
    ...
    [AllowSpendAgainstCanceled] NVARCHAR
(
    80
),
    [AllowNewSpendAgainstExpired] NVARCHAR
(
    80
),
...
(
    ...
    [OmbFundCode] NVARCHAR
(
    80
),
    [OmbAccountTitle] NVARCHAR
(
    80
),
    [AgencySequence] NVARCHAR
...
(
    ...
    [AppropriationDescription] NVARCHAR
(
    80
),
    [FundGroup] NVARCHAR
...
(
    ...
    [EstimatedReimbursmentsTransType] NVARCHAR
(
    80
),
    [ExpenseSpendingControlFlag] NVARCHAR
(
    80
),
    [ObligationSpendingControlFlag] NVARCHAR
...
(
    ...
    [RecordCarryoverAtLowerLevel] NVARCHAR
(
    80
),
    [ReimbursableSpendinption] NVARCHAR
(
    80
),
    [RecoveriesOption] NVARCHAR
(
    80
),
    [RecoveriesSpendinption] NVARCHAR
(
    80
),
    [OriginalBudgetedAmount] DECIMAL
(
    18,
    0
),
    [ApportionmentsPosted] DECIMAL
(
    18,
    0
),
...
(
    ...
    [FundsWithdrawnPriorYearsAmount] DECIMAL
(
    18,
    0
),
    [FundingInAmount] DECIMAL
(
    18,
    0
),
    [FundinutAmount] DECIMAL
(
    18,
    0
),
    [TotalAccrualRecoveries] DECIMAL
(
    18,
    0
),
    [TotalActualReimbursements] DECIMAL
(
    18,
    0
),
    [TotalAgreementReimbursables] DECIMAL
(
    18,
    0
),
    [TotalCarriedForwardIn] DECIMAL
(
    18,
    0
),
    [TotalCarriedForwardOut] DECIMAL
(
    18,
    0
),
...
(
    ...
    [TotalEstimatedRecoveries] DECIMAL
(
    18,
    0
),
    [TotalEstimatedReimbursements] DECIMAL
(
    18,
    0
),
...
(
    ...
    [TotalExpenditureExpenses] DECIMAL
(
    18,
    0
),
    [TotalExpenseAccruals] DECIMAL
(
    18,
    0
),
    [TotalPreCommitments] DECIMAL
(
    18,
    0
),
    [UnliquidatedPreCommitments] DECIMAL
(
    18,
    0
),
