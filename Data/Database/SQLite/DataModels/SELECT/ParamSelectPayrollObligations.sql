PARAMETERS
FiscalYearArgs Text ( 255 ), RcCodeArgs Text ( 255 ), FundCodeArgs Text ( 255 );
SELECT DISTINCTROW Purchases.RpioCode AS RPIO, Purchases.BFY,
       Purchases.AhCode AS [AH Code], Purchases.AhName AS [AH Name], Purchases.FundCode AS FundCode, Purchases.FundName AS FundName, Purchases.AccountCode AS AccountCode, Purchases.ProgramProjectName AS ProgramProjectName, Purchases.BocCode AS BocCode, Purchases.BocName AS BocName, 
