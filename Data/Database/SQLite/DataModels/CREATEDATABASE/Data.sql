...
(
	...
	"BudgetingTransType"  TEXT(80) NULL DEFAULT 'NS',
	"PostedTransType"  TEXT(80) NULL DEFAULT 'NS',
	"EstimatedReimbursableTransType"  TEXT(80) NULL DEFAULT 'NS',
	...
	"StategicReserveTransType"  TEXT(80) NULL DEFAULT 'NS',
	"ProfLossTransType"  TEXT(80) NULL DEFAULT 'NS',
	"EstimatedReimbursableSpendingOption"  TEXT(80) NULL DEFAULT 'NS',
	"EstimatedReimbursableBudgetingOption"  TEXT(80) NULL DEFAULT 'NS',
	"TrackAgreementLowerLevel"  TEXT(80) NULL DEFAULT 'NS',
	"BudgetEstimateLowerLevel"  TEXT(80) NULL DEFAULT 'NS',
	"EstimatedRecoveriesSpendingOption"  TEXT(80) NULL DEFAULT 'NS',
	"EstimatedRecoveriesBudgetingOption"  TEXT(80) NULL DEFAULT 'NS',
	"RecordNextLevel"  TEXT(80) NULL DEFAULT 'NS',
	"RecordBudgetingMismatch"  TEXT(80) NULL DEFAULT 'NS',
	"ProfitLossSpendingOption"  TEXT(80) NULL DEFAULT 'NS',
	"ProfitLossBudgetingOption"  TEXT(80) NULL DEFAULT 'NS',
	"RecordCarryInLowerLevel"  TEXT(80) NULL DEFAULT 'NS',
	"RecordCarryInLowerLevelControl"  TEXT(80) NULL DEFAULT 'NS',
	"RecordCarryInAmountControl"  TEXT(80) NULL DEFAULT 'NS',
	"BudgetingControl"  TEXT(80) NULL DEFAULT 'NS',
	"PostingControl"  TEXT(80) NULL DEFAULT 'NS',
...
(
	...
	"ControlNumber" TEXT(80) DEFAULT 'NS',
	"ProcessedDate" TEXT(80) DEFAULT 'NS',
	"Quarter" TEXT(80) DEFAULT 'NS',
	"Line" TEXT(80) DEFAULT 'NS',
	"Subline" TEXT(80) DEFAULT 'NS',
	...
	"Amount" REAL DEFAULT 0.0,
	"ResourceType" TEXT(80) DEFAULT 'NS',
...
CREATE TABLE IF NOT EXISTS "Obligations" (
	...
	"ReferenceDocumentNumber" TEXT(80) DEFAULT 'NS',
	"ProcessedDate" TEXT(80) DEFAULT 'NS',
...
(
	...
	"ULO"  TEXT(80) NULL DEFAULT 'NS',
	"Expenditures"  TEXT(80) NULL DEFAULT 'NS',
	"Obligations"  TEXT(80) NULL DEFAULT 'NS',
	"Used"  TEXT(80) NULL DEFAULT 'NS',
...
(
	"AppropriationBalancesId" INTEGER NOT NULL UNIQUE,
	"BudgetAccountCode"  TEXT(80) NULL DEFAULT 'NS',
	"BudgetAccountName"  TEXT(80) NULL DEFAULT 'NS',
	"FiscalYear"  TEXT(80) NULL DEFAULT 'NS',
	"FundCode"  TEXT(80) NULL DEFAULT 'NS',
	...
	"EstimatedReimbursements" REAL NULL DEFAULT 0.0,
	"EstimatedRecoveries" REAL NULL DEFAULT 0.0,
	PRIMARY KEY("AppropriationBalancesId" AUTOINCREMENT)
);
...
(
	...
	CONSTRAINT "PrimaryKeyBackUpAllocations" PRIMARY KEY("BackupAllocationsId" AUTOINCREMENT)
);
...
(
	"CostAreasId" INTEGER NOT NULL UNIQUE,
	"Code"  TEXT(80) NULL DEFAULT 'NS',
	"Name"  TEXT(80) NULL DEFAULT 'NS',
...
(
	"DefactosId" INTEGER NOT NULL UNIQUE,
	"StatusOfFundsId" INTEGER NOT NULL,
	"BudgetLevel"  TEXT(80) NULL DEFAULT 'NS',
	"BFY"  TEXT(80) NULL DEFAULT 'NS',
	"EFY"  TEXT(80) NULL DEFAULT 'NS',
...
(
	"DocumentControlNumbersId" INTEGER NOT NULL UNIQUE,
...
(
	"FullTimeEquivialentsId" INTEGER NOT NULL UNIQUE,
...
(
	"GrossAuthorityId" INTEGER NOT NULL UNIQUE,
	"BFY"  TEXT(80) NULL DEFAULT 'NS',
	"EFY"  TEXT(80) NULL DEFAULT 'NS',
	"FundCode"  TEXT(80) NULL DEFAULT 'NS',
	"FundName"  TEXT(80) NULL DEFAULT 'NS',
	...
	"Outlays" REAL NULL DEFAULT 0.0,
	"Available" REAL NULL DEFAULT 0.0,
	PRIMARY KEY("GrossAuthorityId" AUTOINCREMENT)
);
