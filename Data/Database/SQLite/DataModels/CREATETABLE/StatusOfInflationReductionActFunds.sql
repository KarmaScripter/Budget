...
(
	StatusOfInflationReductionActFunds INTEGER NOT NULL UNIQUE,
	StatusOfSupplementalFundingId	INTEGER NOT NULL,
	...
	PRIMARY KEY(StatusOfSupplementalFundingId AUTOINCREMENT)
);