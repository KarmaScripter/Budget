...
GROUP BY Transfers.ReprogrammingNumber, Transfers.ProcessedDate, Transfers.BFY, Transfers.RpioCode,
         Transfers.RpioName, Transfers.AhCode, Transfers.AhName, Transfers.FundCode,
         Transfers.FundName, Transfers.OrgCode, Transfers.OrgName, Transfers.AccountCode,
         ...
         Transfers.BocCode, Transfers.BocName, Transfers.BudgetLevel, Transfers.DocPrefix,
         Transfers.DocType, Transfers.NpmCode, Transfers.Purpose,
