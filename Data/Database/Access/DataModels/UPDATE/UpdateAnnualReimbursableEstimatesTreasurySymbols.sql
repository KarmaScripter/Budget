...
ON (AppropriationLevelAuthority.FiscalYear = Funds.EFY)
    ...
    SET AppropriationLevelAuthority.FundName = Funds.Name, AppropriationLevelAuthority.BudgetAccountCode = Funds.BudgetAccountCode, .BudgetAccountName = Funds.BudgetAccountName;